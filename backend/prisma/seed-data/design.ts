/* ══════════════════════════════════════════════════
   Seed Data — Design / Finish Selections
   Ported from dashboard mock-design.ts
   sandbox-001 -> belmont, greenfield-002 -> wieland
   ══════════════════════════════════════════════════ */

export const SEED_FINISHES = [
  // ─────────────────────────────────────────────
  //  Belmont — Kitchen (6 items)
  // ─────────────────────────────────────────────
  {
    id: 'sb-fin-001',
    projectId: 'belmont',
    ...
    upgrades: [
      { name: 'Wide Plank', priceDelta: 4, spec: '7" wide plank construction' },
      { name: 'Herringbone', priceDelta: 8, spec: 'Herringbone pattern installation' },
    ],
  },
  {
    id: 'sb-fin-002',
    ...
    upgrades: [
      { name: 'Marble', priceDelta: 45, spec: 'Calacatta Gold marble, honed finish' },
      { name: 'Porcelain', priceDelta: 15, spec: 'Large format porcelain slab, book-matched' },
    ],
  },
  {
    id: 'sb-fin-003',
    ...
    upgrades: [
      { name: 'Custom Inset', priceDelta: 150, spec: 'Inset door construction with reveal' },
      { name: 'Walnut', priceDelta: 200, spec: 'Natural walnut veneer, clear finish' },
    ],
  },
  {
    id: 'sb-fin-004',
    ...
    upgrades: [
      { name: 'Zellige', priceDelta: 22, spec: 'Handmade zellige tile, irregular finish' },
      { name: 'Marble Mosaic', priceDelta: 35, spec: 'Marble mosaic pattern, mixed finish' },
    ],
  },
  {
    id: 'sb-fin-005',
    ...
    upgrades: [
      { name: 'Unlacquered Brass', priceDelta: 12, spec: 'Living finish, develops patina over time' },
      { name: 'Knurled', priceDelta: 8, spec: 'Knurled detail for enhanced grip' },
    ],
  },
  {
    id: 'sb-fin-006',
    ...
    upgrades: [
      { name: '48" Range', priceDelta: 4500, spec: '48" dual fuel range with 8 burners' },
      { name: 'Induction', priceDelta: 1200, spec: '36" induction cooktop upgrade' },
    ],
  },

  // ─────────────────────────────────────────────
  //  Belmont — Master Bath (5 items)
  // ─────────────────────────────────────────────
  {
    id: 'sb-fin-007',
    projectId: 'belmont',
    ...
    upgrades: [
      { name: 'Heated', priceDelta: 8, spec: 'Radiant heat mat installation' },
      { name: 'Natural Stone', priceDelta: 25, spec: 'Marble tile, honed finish' },
    ],
  },
  {
    id: 'sb-fin-008',
    ...
    upgrades: [
      { name: 'Book-Match', priceDelta: 30, spec: 'Book-matched marble slab installation' },
      { name: 'Fluted', priceDelta: 18, spec: 'Fluted porcelain tile feature wall' },
    ],
  },
  {
    id: 'sb-fin-009',
    ...
    upgrades: [
      { name: 'Waterworks', priceDelta: 850, spec: 'Waterworks faucet, premium finish' },
      { name: 'Brizo', priceDelta: 320, spec: 'Brizo Litze collection, articulating design' },
    ],
  },
  {
    id: 'sb-fin-010',
    ...
    upgrades: [
      { name: 'Custom Double', priceDelta: 1500, spec: 'Double vanity configuration, 72" wide' },
      { name: 'Stone Integrated', priceDelta: 2200, spec: 'Integrated stone countertop and sink' },
    ],
  },
  {
    id: 'sb-fin-011',
    ...
    upgrades: [
      { name: 'Decorative Sconces', priceDelta: 180, spec: 'Wall sconces, flanking mirror' },
      { name: 'Linear', priceDelta: 350, spec: 'Linear vanity light, integrated LED' },
    ],
  },

  // ─────────────────────────────────────────────
  //  Belmont — Guest Bath (3 items)
  // ─────────────────────────────────────────────
  {
    id: 'sb-fin-012',
    projectId: 'belmont',
  ...
  // ─────────────────────────────────────────────
  {
    ...
    imageUrl: '/images/finishes/kitchen-flooring.jpg',
    upgrades: [
      { name: 'Wide Plank', priceDelta: 3, spec: '7" wide plank option' },
    ],
  },
  {
    id: 'gf-fin-002',
    ...
    imageUrl: '/images/finishes/kitchen-countertop.jpg',
    upgrades: [
      { name: 'Premium Quartz', priceDelta: 25, spec: 'Designer quartz with veining' },
    ],
  },
  {
    id: 'gf-fin-003',
    ...
    imageUrl: '/images/finishes/kitchen-cabinetry.jpg',
    upgrades: [
      { name: 'Soft-Close Upgrade', priceDelta: 50, spec: 'Soft-close hinges and drawer glides' },
    ],
  },

  // ─────────────────────────────────────────────
  //  Wieland — Master Bath (2 items)
  // ─────────────────────────────────────────────
  {
    id: 'gf-fin-004',
    projectId: 'wieland',
    ...
    upgrades: [
      { name: 'Large Format', priceDelta: 8, spec: '24x48 large format tile' },
    ],
  },
  {
    id: 'gf-fin-005',
    ...
    upgrades: [
      { name: 'Brushed Nickel', priceDelta: 50, spec: 'Upgraded finish in brushed nickel' },
      { name: 'Designer Collection', priceDelta: 200, spec: 'Designer fixture collection' },
    ],
  },

  // ─────────────────────────────────────────────
  //  Wieland — Living Room (2 items)
  // ─────────────────────────────────────────────
  {
    id: 'gf-fin-006',
    projectId: 'wieland',
  ...
  // ─────────────────────────────────────────────
  {
    ...
    imageUrl: '/images/finishes/bedroom-flooring.jpg',
    upgrades: [
      { name: 'Premium Carpet', priceDelta: 3, spec: 'Nylon fiber upgrade, stain resistant' },
    ],
  },
];
